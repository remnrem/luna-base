...
void proc_dummy( const std::string & p , const std::string & p2 )
{
  ...
  //     Eigen::MatrixXd A = MatrixXd::Random(3,3) + MatrixXd::Constant(22) ; 

      
  //     std::exit(1);
      
      
  //     std::string method = p2;
  ...
  //     if ( p2 == "mine0" )
  // 	{
  // 	  // naive w/ Data::Matrix<double>	  
  // 	  Data::Matrix<double> m( nr, nc);
  // 	  for (int i=0; i<nr; i++)
  // 	    for (int j=0; j<nc; j++)
  // 	      m(i,j) = i + j;
  ...
  // 	    {
  // 	      std::cout << "k = " << k << "\n";
  // 	      Data::Matrix<double> R = Statistics::matrix_multiply( m , Statistics::transpose(m) ) ;
  // 	      std::cout << R(22,22) << "\n";
  // 	    }
