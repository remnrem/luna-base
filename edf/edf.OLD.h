...
class edf_record_t
{
 ...
 public:
  ...
  void add_pdata( const std::vector<double> & );
 ...
 public:
  ...
  inline static int tc2dec( char a , char b );
  inline static void dec2tc( int x , char * a , char * b );
...
public:
  ...
  //
  // Write an INDEX for a EDF (i.e. EDF+ file with time-track only)
  //
